...
ap.add_argument('-c', '--config', 
                help = 'path to yolo config file', default='/Users/madair/Downloads/YOLO/yolov3-tiny.cfg')
ap.add_argument('-w', '--weights', 
                help = 'path to yolo pre-trained weights', default='/Users/madair/darknet/backup/yolov3-tiny_900.weights')
ap.add_argument('-cl', '--classes', 
                help = 'path to text file containing class names',default='/Users/madair/darknet/custom/objects.names')
args = ap.parse_args()
...
#cap = cv2.VideoCapture('/Users/madair/Downloads/YOLO/test_imovie.mov')

while cv2.waitKey(1) < 0:
    
    hasframe, image = cap.read()
    #image = cv2.imread('/Users/madair/Downloads/test_trash.jpg',0)
